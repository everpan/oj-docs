...
- 关联：[202609112324-web-layout-and-codegen-guide-design](/frontend/design/web-layout-codegen)（本次改名决策）、202609030854-api-contract-design（契约原始设计）、`oj-fullstack-tutorial.md`（上手操作向）
