<!-- 由 scripts/sync-docs.mjs 于 2026-09-18 从 `oj-module:docs/prd/202609112324-web-layout-and-codegen-guide-design.md` 生成，请勿直接编辑；改源文件后运行 `npm run sync` -->
...
<p class="gen-note">generated: 2026-09-18 · 本页由脚本从 oj-module:docs/prd/202609112324-web-layout-and-codegen-guide-design.md 同步生成，修改请改源文件后运行 npm run sync。</p>
...
- 关联：[202609110947-oj-module-two-package-consolidation-design](/frontend/design/two-package-consolidation/)（两包整合）、`framework-verification-playbook.md`
