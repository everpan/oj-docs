<!-- 由 scripts/sync-docs.mjs 于 2026-09-12 从 `only-js:docs/benchmarks.md` 生成，请勿直接编辑；改源文件后运行 `npm run sync` -->
...
<p class="gen-note">generated: 2026-09-12 · 本页由脚本从 only-js:docs/benchmarks.md 同步生成，修改请改源文件后运行 npm run sync。</p>
