<!-- 由 scripts/sync-docs.mjs 于 2026-09-12 从 `only-js:sample/src/news/README.md` 生成，请勿直接编辑；改源文件后运行 `npm run sync` -->

---
title: news —— WebSocket + 发布订阅 + 会话状态
generated: 2026-09-12
---

<p class="gen-note">generated: 2026-09-12 · 本页由脚本从 only-js:sample/src/news/README.md 同步生成，修改请改源文件后运行 npm run sync。</p>


# news —— WebSocket + 发布订阅 + 会话状态

教学目标（对应 [../../MODULES.md](/sample/modules-tour) §⑤，WS 专题见
[../../../docs/websocket.md](/reference/websocket)）：
